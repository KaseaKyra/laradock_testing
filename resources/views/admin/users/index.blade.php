...
<div class="container">
    <div class="row">
        <div class="col-12">
            <button class="btn btn-success mb-2" id="create-new-user">Add User</button>
            <table class="table table-bordered" id="laravel_crud">
                ...
                @foreach($users as $user)
                    <tr id="user_id_{{ $user->id }}">
                        ...
                        <td>{{ $user->email }}</td>
                        <td>
                            <button href="javascript:void(0)" id="{{ $user->id }}" data-id="{{ $user->id }}"
                                    class="btn btn-info edit-user">Edit
                            </button>
                        </td>
                        <td>
                            <a href="javascript:void(0)" id="{{ $user->id }}" data-id="{{ $user->id }}"
